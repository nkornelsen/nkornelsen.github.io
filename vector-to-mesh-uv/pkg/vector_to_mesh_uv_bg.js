...
/**
* @param {string} mesh_data
* @returns {any}
*/
export function generate_images(mesh_data) {
    var ptr0 = passStringToWasm0(mesh_data, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
    var ret = wasm.generate_images(ptr0, len0);
